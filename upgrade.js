...
class Item {
    ...
    update() {
        ...
        this.updateText();
        if (game.gold.gt(this.maxFloor) || ((this.name.search(/potent/) > -1 || this.name.search(/nightmare/) > -1)&& game.nightmareLayer.lt(1)) || (this.name.search(/shadow\sblood/) > -1 && game.nightmareLayer.lt(1))) $(this.id).style.display = 'none';
