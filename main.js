...
let ITEMS = [new Item("shp", "small health potion", 100, D(1e100)), new Item("mhp", "medium health potion", 300, D(1e100)), new Item("lhp", "large health potion", 800, D(1e100)), new Item("suhp", "super health potion", 1800, Infinity), new Item("ssp", "small strength potion", 500, D(1e100)), new Item("msp", "medium strength potion", 2500, D(1e100)), new Item("lsp", "large strength potion", 1e8, Infinity), new Item("slp", "small luck potion", 1e10, D('1e2005')), new Item("mlp", "medium luck potion", "1e2000", D('eee4')), new Item("llp", "large luck potion", "eee3", Infinity), new Item("dhp", "dark health potion", 1, Infinity, true), new Item("dsp", "dark strength potion", 1, Infinity, true), new Item("dlp", "dark luck potion", 1, Infinity, true), new Item("pdhp", "potent dark health potion", 10, Infinity, true), new Item("pdsp", "potent dark strength potion", 10, Infinity, true), new Item("pdlp", "potent dark luck potion", 10, Infinity, true), new Item("np", "nightmare potion", 1000, Infinity, true), new Item("sb", "shadow blood", "10^^10", Infinity, true)];
